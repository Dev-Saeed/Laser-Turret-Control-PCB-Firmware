...
// Mode 1: Wheel (continuous speed) mode, controlled by 0x2E (BIT15 = direction)
// Mode 2: PWM open-loop speed mode, controlled by 0x2C (BIT10 = direction)
// Mode 3: Step servo mode, controlled by 0x2A (BIT15 = direction), angle limits (0x09, 0x0B) must be 0 for unlimited steps
int SMS_STS::setOperatingMode(u8 ID, u8 Mode)
{
